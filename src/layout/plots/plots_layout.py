...
def plots_layout() -> list:
    return [
        html.Div([
            ...
            html.Div(dcc.Graph(id="timeline-monsters-plot", style={"width": "100%", "height": "100%"},config={'displayModeBar': False}), style={"flex": "1", "minWidth": "45%"}),
            html.Div(dcc.Graph(id="timeline-structures-plot", style={"width": "100%", "height": "100%"},config={'displayModeBar': False, 'staticPlot': True }), style={"flex": "1", "minWidth": "45%"}),
