...
def plots_layout() -> list:
    return [
        html.Div([
            html.Div(dcc.Graph(id="kill-plot", style={"width": "100%", "height": "100%"}), style={"flex": "1", "minWidth": "45%"}),
            html.Div(dcc.Graph(id="heatmap-plot", style={"width": "100%", "height": "100%"}), style={"flex": "1", "minWidth": "45%"}),
            html.Div(dcc.Graph(id="objective-plot", style={"width": "100%", "height": "100%"}), style={"flex": "1", "minWidth": "45%"}),
            html.Div(dcc.Graph(id="first-drake-plot", style={"width": "100%", "height": "100%"}), style={"flex": "1", "minWidth": "45%"}),
            html.Div(dcc.Graph(id="timeline-monsters-plot", style={"width": "100%", "height": "100%"}), style={"flex": "1", "minWidth": "45%"}),
            html.Div(dcc.Graph(id="timeline-structures-plot", style={"width": "100%", "height": "100%"}), style={"flex": "1", "minWidth": "45%"}),
            html.Div(dcc.Graph(id="timeline-kills-plot", style={"width": "100%", "height": "100%"}), style={"flex": "1", "minWidth": "45%"}),
            html.Div(dcc.Graph(id="map-timeline-mplot", style={"width": "100%", "height": "100%"}), style={"flex": "1", "minWidth": "45%"}),
        ], style={
            "display": "flex",
            "flexWrap": "wrap",
            "gap": "20px",
